# Contribute to WalkBright

This guide details how to use issues and pull requests (for new code) to improve WalkBright.
...
Out of respect for our volunteers, issues and pull requests not in line with the guidelines listed in this document may be closed without notice.
...
The [issue tracker](https://github.com/CUTR-at-USF/walk-bright/issues) is only for obvious bugs, misbehavior, & feature requests in the latest stable or development release of WalkBright. When submitting an issue please conform to the issue submission guidelines listed below. Not all issues will be addressed and your issue is more likely to be addressed if you submit a pull request which partially or fully addresses the issue.

### Issue tracker guidelines

**[Search](https://github.com/CUTR-at-USF/walk-bright/search?q=&ref=cmdform&type=Issues)** for similar entries before submitting your own, there's a good chance somebody else had the same issue or feature request. Show your support with `:+1:` and/or join the discussion. Please submit issues in the following format (as the first post) and feature requests in a similar format:
...
We welcome pull requests with fixes and improvements to WalkBright code, tests, and/or documentation. The features we would really like a pull request for are [open issues with the enhancements label](https://github.com/CUTR-at-USF/walk-bright/issues?labels=enhancement&page=1&state=open).
...
9. [Search for issues](https://github.com/CUTR-at-USF/walk-bright/search?q=&ref=cmdform&type=Issues) related to your pull request and mention them in the pull request description or comments
...
* It keeps the WalkBright code base clean and well structured
